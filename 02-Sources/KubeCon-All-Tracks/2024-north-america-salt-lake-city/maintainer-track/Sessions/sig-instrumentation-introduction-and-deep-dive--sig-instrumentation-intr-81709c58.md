...
speakers: ["Han Kang", "David Ashpole", "Richa Banker", "Google", "Damien Grisonnet", "Red Hat"]
sched_url: https://kccncna2024.sched.com/event/1how1/sig-instrumentation-introduction-and-deep-dive-han-kang-david-ashpole-richa-banker-google-damien-grisonnet-red-hat
youtube_search_url: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+and+Deep+Dive+CNCF+KubeCon+2024
slides: []
status: parsed
---
...
- Speakers: Han Kang, David Ashpole, Richa Banker, Google, Damien Grisonnet, Red Hat
- Schedule: https://kccncna2024.sched.com/event/1how1/sig-instrumentation-introduction-and-deep-dive-han-kang-david-ashpole-richa-banker-google-damien-grisonnet-red-hat
- Busca YouTube: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+and+Deep+Dive+CNCF+KubeCon+2024
...
- Schedule oficial: https://kccncna2024.sched.com/event/1how1/sig-instrumentation-introduction-and-deep-dive-han-kang-david-ashpole-richa-banker-google-damien-grisonnet-red-hat
- YouTube search: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+and+Deep+Dive+CNCF+KubeCon+2024
## YouTube enrichment
...
- Match score: 0.866
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2024/sig-instrumentation-introduction-and-deep-dive/BYQxStXTqeA.txt
