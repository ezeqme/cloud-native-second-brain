...
sched_url: https://kccncna2023.sched.com/event/1R2pv/kubernetes-sig-storage-intro-deep-dive-xing-yang-vmware-michelle-au-google
youtube_search_url: https://www.youtube.com/results?search_query=Kubernetes+SIG+Storage%3A+Intro+%26+Deep+Dive+CNCF+KubeCon+2023
slides: []
status: parsed
---
...
- Speakers: Xing Yang, VMware, Michelle Au, Google
- Schedule: https://kccncna2023.sched.com/event/1R2pv/kubernetes-sig-storage-intro-deep-dive-xing-yang-vmware-michelle-au-google
- Busca YouTube: https://www.youtube.com/results?search_query=Kubernetes+SIG+Storage%3A+Intro+%26+Deep+Dive+CNCF+KubeCon+2023
...
- Schedule oficial: https://kccncna2023.sched.com/event/1R2pv/kubernetes-sig-storage-intro-deep-dive-xing-yang-vmware-michelle-au-google
- YouTube search: https://www.youtube.com/results?search_query=Kubernetes+SIG+Storage%3A+Intro+%26+Deep+Dive+CNCF+KubeCon+2023
## YouTube enrichment
...
- Match score: 0.765
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2023/kubernetes-sig-storage-intro-deep-dive/tGSEyEdh5ug.txt
