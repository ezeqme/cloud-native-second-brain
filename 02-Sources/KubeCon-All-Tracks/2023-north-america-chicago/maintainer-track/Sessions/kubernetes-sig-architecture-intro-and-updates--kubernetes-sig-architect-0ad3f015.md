...
speakers: ["John Belamaric", "Google", "Davanum Srinivas", "Amazon Web Services"]
sched_url: https://kccncna2023.sched.com/event/1R2rJ/kubernetes-sig-architecture-intro-and-updates-john-belamaric-google-davanum-srinivas-amazon-web-services
youtube_search_url: https://www.youtube.com/results?search_query=Kubernetes+SIG+Architecture+Intro+and+Updates+CNCF+KubeCon+2023
slides: []
status: parsed
---

# Kubernetes SIG Architecture Intro and Updates - John Belamaric, Google & Davanum Srinivas, Amazon Web Services
...
- Speakers: John Belamaric, Google, Davanum Srinivas, Amazon Web Services
- Schedule: https://kccncna2023.sched.com/event/1R2rJ/kubernetes-sig-architecture-intro-and-updates-john-belamaric-google-davanum-srinivas-amazon-web-services
- Busca YouTube: https://www.youtube.com/results?search_query=Kubernetes+SIG+Architecture+Intro+and+Updates+CNCF+KubeCon+2023
...
- Schedule oficial: https://kccncna2023.sched.com/event/1R2rJ/kubernetes-sig-architecture-intro-and-updates-john-belamaric-google-davanum-srinivas-amazon-web-services
- YouTube search: https://www.youtube.com/results?search_query=Kubernetes+SIG+Architecture+Intro+and+Updates+CNCF+KubeCon+2023
## YouTube enrichment
...
- Match score: 0.818
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2023/kubernetes-sig-architecture-intro-and-updates/8YaKHvoVZy4.txt
