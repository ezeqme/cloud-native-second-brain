...
speakers: ["Wojciech Tyczyński", "Google", "Marcel Zięba", "Isovalent"]
sched_url: https://kccncna2023.sched.com/event/1R2pT/intro-+-deep-dive-kubernetes-sig-scalability-wojciech-tyczynski-google-marcel-zieba-isovalent
youtube_search_url: https://www.youtube.com/results?search_query=Intro+%2B+Deep+Dive%3A+Kubernetes+SIG+Scalability+CNCF+KubeCon+2023
slides: []
status: parsed
---
...
- Speakers: Wojciech Tyczyński, Google, Marcel Zięba, Isovalent
- Schedule: https://kccncna2023.sched.com/event/1R2pT/intro-+-deep-dive-kubernetes-sig-scalability-wojciech-tyczynski-google-marcel-zieba-isovalent
- Busca YouTube: https://www.youtube.com/results?search_query=Intro+%2B+Deep+Dive%3A+Kubernetes+SIG+Scalability+CNCF+KubeCon+2023
...
- Schedule oficial: https://kccncna2023.sched.com/event/1R2pT/intro-+-deep-dive-kubernetes-sig-scalability-wojciech-tyczynski-google-marcel-zieba-isovalent
- YouTube search: https://www.youtube.com/results?search_query=Intro+%2B+Deep+Dive%3A+Kubernetes+SIG+Scalability+CNCF+KubeCon+2023
## YouTube enrichment
...
- Match score: 0.844
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2023/intro-deep-dive-kubernetes-sig-scalability/bxY5Q5Eoj0s.txt
