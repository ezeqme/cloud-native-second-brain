...
sched_url: https://kccnceu2026.sched.com/event/2EF4s/rook-intro-and-deep-dive-with-ceph-storage-artem-torubarov-deepika-upadhyay-clyso-niels-de-vos-red-hat
youtube_search_url: https://www.youtube.com/results?search_query=Rook%3A+Intro+and+Deep+Dive+With+Ceph+Storage+CNCF+KubeCon+2026
slides: []
status: parsed
---
...
- Speakers: Artem Torubarov, Deepika Upadhyay, Clyso, Niels de Vos, Red Hat
- Schedule: https://kccnceu2026.sched.com/event/2EF4s/rook-intro-and-deep-dive-with-ceph-storage-artem-torubarov-deepika-upadhyay-clyso-niels-de-vos-red-hat
- Busca YouTube: https://www.youtube.com/results?search_query=Rook%3A+Intro+and+Deep+Dive+With+Ceph+Storage+CNCF+KubeCon+2026
...
- Schedule oficial: https://kccnceu2026.sched.com/event/2EF4s/rook-intro-and-deep-dive-with-ceph-storage-artem-torubarov-deepika-upadhyay-clyso-niels-de-vos-red-hat
- YouTube search: https://www.youtube.com/results?search_query=Rook%3A+Intro+and+Deep+Dive+With+Ceph+Storage+CNCF+KubeCon+2026
## YouTube enrichment

- YouTube: https://www.youtube.com/watch?v=bL5Ay28KPOI
- YouTube title: Rook: Intro and Deep Dive with Ceph
- Match score: 0.975
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2026/rook-intro-and-deep-dive-with-ceph-storage/bL5Ay28KPOI.txt
