...
speakers: ["Damien Grisonnet", "Red Hat", "Han Kang", "David Ashpole", "Google"]
sched_url: https://kccncna2022.sched.com/event/182PN/sig-instrumentation-introduction-and-deep-dive-damien-grisonnet-red-hat-han-kang-david-ashpole-google
youtube_search_url: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+And+Deep+Dive+CNCF+KubeCon+2022
slides: []
status: parsed
---
...
- Speakers: Damien Grisonnet, Red Hat, Han Kang, David Ashpole, Google
- Schedule: https://kccncna2022.sched.com/event/182PN/sig-instrumentation-introduction-and-deep-dive-damien-grisonnet-red-hat-han-kang-david-ashpole-google
- Busca YouTube: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+And+Deep+Dive+CNCF+KubeCon+2022
...
- Schedule oficial: https://kccncna2022.sched.com/event/182PN/sig-instrumentation-introduction-and-deep-dive-damien-grisonnet-red-hat-han-kang-david-ashpole-google
- YouTube search: https://www.youtube.com/results?search_query=SIG+Instrumentation+Introduction+And+Deep+Dive+CNCF+KubeCon+2022
## YouTube enrichment
...
- Match score: 0.866
- Transcript file: _sources/transcripts/youtube-enriched/kubecon/2022/sig-instrumentation-introduction-and-deep-dive/BYQxStXTqeA.txt
